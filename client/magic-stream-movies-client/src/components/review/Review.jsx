...
const Review = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        try {
            const response = await axiosPrivate.patch(`/updatereview/${imdb_id}`, {admin_review: reviewText.current.value})
            setMovie (
                () => (
                    {
                        ...movie,
                                        ...
                                        ? (
                                            <Form onSubmit={handleSubmit}>
                                                <Form.Group className="mb-3" controlId="adminReviewTextarea">
                                                    ...
                                                    <Form.Control ref={reviewText} required as="textarea" rows={8} defaultValue={movie?.admin_review} placeholder="Write your review here..." style={{resize: "vertical"}}/>
                                                </Form.Group>
